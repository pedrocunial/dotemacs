...
values."
  (setq-default
   ...
   ;; If non-nil layerswith lazy install support are lazy installed.
...
values."
  ...
  (setq-default
   ...
   ;; source settings. Ere lse, disable fuzzy matching in all sources.
   ;; (default 'always)
